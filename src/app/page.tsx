...
const BentoFeatures = dynamic(
  () => import("@/components/site/BentoFeatures").then((mod) => mod.BentoFeatures),
  {
    ssr: false,
  },
);

const StickyShowcase = dynamic(
  () => import("@/components/site/StickyShowcase").then((mod) => mod.StickyShowcase),
  {
    ssr: false,
  },
);
