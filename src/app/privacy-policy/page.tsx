        ...
        <div className="container-px max-w-4xl mx-auto">
          <div className="prose prose-slate max-w-none space-y-8 text-muted-foreground leading-relaxed">
            <div>
              ...
              <p>
                We collect personal information that you voluntarily provide to us when submitting
                inquiries through our contact form or subscribing to our newsletter. This
                information may include your name, email address, phone number, company name, and
                any details shared within your messages.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1">
                <li>
                  Respond to your inquiries, quote requests, and crop-protection requirements.
                </li>
                <li>
                  Send updates, newsletters, and promotional information (only if you have opt-in
                  subscribed).
                </li>
            ...
            <div>
              ...
              <p>
                ...
                information when you enter, submit, or access your details. Your data is stored
            ...
            <div>
              ...
              <p>
                ...
                website, conducting our business, or servicing you, such as EmailJS for processing
                contact form submissions, as long as those parties agree to keep this information
                confidential.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Our website may use cookies to understand and save your preferences for future
