        ...
        <div>
          ...
          <Reveal delay={0.1}>
            <h2 className="mt-4 text-2xl md:text-4xl font-bold leading-tight">
              Let's grow <span className="text-gradient">better fruit</span> together.
            </h2>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mt-4 text-muted-foreground">
              Tell us about your orchard, target sizes, and quantities. We respond within one
              business day.
            </p>
          </Reveal>
          ...
          <form onSubmit={onSubmit} className="glass rounded-3xl p-6 md:p-8 shadow-elevated">
            ...
            <div className="mt-4">
              ...
              <textarea
                name="message"
                rows={5}
                className="mt-1.5 w-full rounded-xl bg-background/60 border px-4 py-3 outline-none focus:ring-2 focus:ring-primary"
                placeholder="Crop, sizes, quantity, timeline…"
              />
