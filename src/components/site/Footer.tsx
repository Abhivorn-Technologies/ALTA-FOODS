      ...
      <div className="container-px max-w-7xl mx-auto py-16 grid gap-12 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-2">
            <img src={logo} alt="ALTA FOODS" className="h-10 w-10 bg-background/90 rounded-lg p-1" />
            <div>
        ...
        <div>
          ...
          <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
            <input type="email" required placeholder="Email address" className="flex-1 rounded-full bg-background/10 px-4 py-2 text-sm placeholder:opacity-60 focus:outline-none focus:ring-2 focus:ring-primary-glow" />
            <button className="rounded-full bg-leaf px-4 py-2 text-sm font-semibold">Join</button>
          </form>
        </div>
      </div>
