...
const features = [
  {
    ...
    desc: "Organic, biodegradable, and eco-friendly composition.",
  },
  {
    icon: Sun,
    title: "UV Resistance",
    desc: "Blocks harmful UV rays while allowing essential sunlight.",
  },
  {
    icon: Droplets,
    title: "Water Resistance",
    desc: "Repels moisture to prevent fungal growth and rot.",
  },
  {
    icon: ShieldCheck,
    title: "Breathable",
    desc: "Maintains an optimal microclimate for fruit development.",
  },
  {
    icon: Award,
    title: "Standard Quality",
    desc: "Ensures long performance and consistent, premium results.",
  },
];
        ...
        <div className="order-1 lg:order-2">
          ...
          <Reveal delay={0.2}>
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
              Our extensive product range includes Guava Protection Bags, Pear Fruit Protection
              Bags, Dragon Fruit Protection Bags, and Pomegranate Protection Bags. We are deeply
              engaged in providing the highest quality physical protection for your harvests.
            </p>
          </Reveal>
