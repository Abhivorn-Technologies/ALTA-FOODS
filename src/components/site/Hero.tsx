...
const slides = [
  { fruit: "All Fruits", image: "/images/hero/products.png", color: "from-green-400 to-yellow-400" },
  ...
  { fruit: "Pomegranates", image: "/images/hero/pomegranate.png", color: "from-rose-400 to-red-600" },
    ...
    <section className="relative min-h-[95vh] lg:min-h-[850px] flex items-center justify-center pt-20 pb-20 overflow-hidden">
      ...
      <div className="container-px max-w-5xl mx-auto text-center text-primary-foreground relative z-10 flex flex-col items-center mt-12">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <Link href="/products" className="group inline-flex items-center gap-2 rounded-full bg-leaf text-primary-foreground px-8 py-3.5 text-base font-bold shadow-glow hover:shadow-soft transition-all hover:-translate-y-1">
            Explore Products <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition" />
          </Link>
          <Link href="/contact" className="inline-flex items-center gap-2 rounded-full glass-dark text-primary-foreground px-8 py-3.5 text-base font-bold border border-white/20 hover:bg-white/10 transition-all hover:-translate-y-1">
            Contact Us
          </Link>
        </div>
