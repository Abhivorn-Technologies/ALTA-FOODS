...
const items = [
  {
    t: "Mango Farms",
    d: "Premium Alphonso, Kesar & Banganapalli protection.",
    c: "from-amber-500/40 to-primary/40",
  },
  {
    t: "Organic Farming",
    d: "Chemical-free certification support.",
    c: "from-primary/50 to-emerald-500/40",
  },
  {
    t: "Commercial Gardens",
    d: "Bulk packaging for large-scale orchards.",
    c: "from-orange-500/40 to-bark/50",
  },
  {
    t: "Export Protection",
    d: "Cosmetic-grade fruit for global markets.",
    c: "from-primary/40 to-blue-500/30",
  },
  {
    t: "Sustainable Agri",
    d: "Government and FPO partnerships.",
    c: "from-lime-500/40 to-primary/50",
  },
];
  ...
  return (
    <section ref={ref} className="py-24 relative overflow-hidden">
      <motion.div
        style={{ y }}
        aria-hidden
        className="absolute -top-20 -right-20 h-72 w-72 rounded-full bg-leaf opacity-20 blur-3xl"
      />
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <Reveal delay={0.1}>
            <h2 className="mt-4 text-3xl md:text-5xl font-bold">
              From small orchards to global exports.
            </h2>
          </Reveal>
        </div>
