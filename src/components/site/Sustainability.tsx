      ...
      <div className="container-px max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <Reveal delay={0.1}>
            <h2 className="mt-4 text-3xl md:text-5xl font-bold leading-tight">
              Sustainable farming <span className="text-gradient">starts here.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.2}>
        ...
        <Reveal>
          <div className="relative">
            ...
            <img
              src={typeof sus === "object" ? sus.src : sus}
              alt="Compostable paper fruit bag on fertile soil"
              loading="lazy"
              className="relative rounded-3xl shadow-elevated w-full aspect-[4/3] object-cover"
            />
            <motion.div
              animate={{ y: [0, -10, 0] }}
              transition={{ duration: 4, repeat: Infinity }}
              className="absolute top-6 -left-4 glass rounded-2xl p-3 shadow-soft flex items-center gap-2"
            >
              <Leaf className="h-5 w-5 text-primary" />{" "}
              <span className="text-sm font-semibold">Carbon-conscious</span>
            </motion.div>
          </div>
        </Reveal>
      </div>
